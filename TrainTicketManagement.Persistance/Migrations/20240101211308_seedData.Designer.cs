...
namespace TrainTicketManagement.Persistance.Migrations
{
    ...
    [Migration("20240101211308_seedData")]
            ...
            modelBuilder.Entity("TrainTicketManagement.Domain.Entities.Train", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 1, 1, 22, 13, 7, 572, DateTimeKind.Local).AddTicks(7859),
                            Destination = "Wroclaw",
            ...
            modelBuilder.Entity("TrainTicketManagement.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 1, 1, 22, 13, 7, 572, DateTimeKind.Local).AddTicks(7312),
