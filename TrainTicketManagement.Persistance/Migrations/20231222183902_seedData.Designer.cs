...
namespace TrainTicketManagement.Persistance.Migrations
{
    ...
    [Migration("20231222183902_seedData")]
            ...
            modelBuilder.Entity("TrainTicketManagement.Domain.Entities.Train", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2023, 12, 22, 19, 39, 1, 916, DateTimeKind.Local).AddTicks(1731),
                            Destination = "Wroclaw",
            ...
            modelBuilder.Entity("TrainTicketManagement.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 12, 22, 19, 39, 1, 916, DateTimeKind.Local).AddTicks(1118),
